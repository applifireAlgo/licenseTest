...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("Hxx87mJRKUWLfRX01XUonosG8d4RmRaQ");
            country.setCapitalLatitude(4);
            country.setCapitalLongitude(6);
            country.setCountryCode1("etH");
            country.setCountryCode2("wKK");
            country.setCountryFlag("Ey04IkUV9A335jNFmTdzGYuomibIlr13ZWPWeSaefkmIqPqB6g");
            country.setCountryName("mTOugZZEggggzTZk7kPfOprdz0vD8t9kn2fhKa1EatJxQoDt0e");
            country.setCurrencyCode("XQo");
            country.setCurrencyName("rLn9ly9AeT4Zal6uxfW7rLBYKJN107puM9LTny13hJ1VpsXsVU");
            country.setCurrencySymbol("3ZSqOP2k5NUxrZecMRut3IytqL6ju2Oi");
            country.setIsoNumeric(7);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("ZpsHCbVQMpUcrjbsqnyxDm92ItwudM3Cb0ZCWuGQ1PKnWuOYO3");
            currency.setUnicodeDecimal("11V3GufySIc64hMvesaAqapLMPbzvU1z1GoJofSNrt0eJz86bV");
            currency.setUnicodeHex("aUzL9GEhGXQPgBpeYcaZUc5Us17NUbWWgWFF3j6BkGyVqG3b1g");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("Z0pCEvaxsJ3BsdY6SScAKjF0PL2KNqX43epDt9QMGh8XgVc580");
            currency.setUnicodeDecimal("bjYSbwtG9w2vICNr7r3repDpioAUCHNzFpcWSAiMrNVQv863v8");
            currency.setUnicodeHex("H0hDZ6UCh11otpbj1tDkRwrTGYwbyOC8Cb3KBeJfYxHSN23ZjI");
