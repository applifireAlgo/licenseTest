...
import projectone.app.server.repository.QuestionRepository;
...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("HfONPqAXbisRZVOAiu9tvukDqlaVXWreoPSpCmE9rkZcYYBLt0");
            question.setQuestionDetails("BGm");
            question.setQuestionIcon("hqRbBOTGjtQlpQL5SmgeALexpmlv8ZJH4Nu2WXgu9XuHVLZoUw");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("oago9CnRIk7t9w76q1Fii8yh5TL7wDFxiNlLXtv5On1znVaQsK");
            question.setQuestionDetails("Ad1");
            question.setQuestionIcon("DtyU01Eoi5Ol6Prsq22NkEiu9GRtHYe4pp5jTbfbMUs19kiEfi");
