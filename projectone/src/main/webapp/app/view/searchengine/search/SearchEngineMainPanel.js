Ext.define('Projectone.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	alias : [ 'layout.accordion' ],
	xtype : 'solrsearchmainpanel',
	

	requires : ['Projectone.view.searchengine.search.NorthPanel', 'Projectone.view.searchengine.search.SearchResult','Projectone.view.searchengine.search.SearchEngineMainPanelController'],
