Ext
		.define(
				'Projectone.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Projectone.view.searchengine.search.SearchEngineMainPanelController','Projectone.view.searchengine.search.PanelHeaderField' ,'Projectone.view.searchengine.search.ReportGridView','Projectone.view.searchengine.search.ReportChartView','Projectone.view.searchengine.search.documentView','Projectone.view.searchengine.search.DouMeanView','Projectone.view.googlemaps.map.MapPanel'],
