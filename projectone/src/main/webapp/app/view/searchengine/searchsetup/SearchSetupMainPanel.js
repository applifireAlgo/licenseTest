 ...
 * 
 */
Ext.define('Projectone.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Projectone.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Projectone.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
