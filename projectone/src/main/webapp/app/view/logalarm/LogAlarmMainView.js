 ...
 * 
 */
Ext.define('Projectone.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Projectone.view.logalarm.LogAlarmMainViewController',
			'Projectone.view.logalarm.tree.LogAlarmTreePanel',
			'Projectone.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
