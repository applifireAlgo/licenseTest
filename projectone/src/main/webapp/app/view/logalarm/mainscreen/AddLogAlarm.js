 ...
 * 
 */
Ext.define('Projectone.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Projectone.view.logalarm.mainscreen.AddLogAlarmController',
			'Projectone.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Projectone.view.logalarm.mainscreen.AppAlarmPanel',
