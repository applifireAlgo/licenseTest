Ext.define('Projectone.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Projectone.view.usermanagement.enduser.UserProfileController', 'Projectone.view.usermanagement.admin.AddUserDetailsViewModel', 'Projectone.model.AddUserDataModel' ],
