Ext.define('Projectone.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Projectone.view.usermanagement.admin.UserPasswordReset',
	            'Projectone.view.usermanagement.admin.AddUserDetails',
	            'Projectone.view.usermanagement.admin.ViewUser'],
