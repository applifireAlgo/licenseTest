Ext.define('Projectone.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Projectone.view.usermanagement.admin.AddUserDetailsViewModel', 'Projectone.model.AddUserDataModel' ],
