Ext.define('Projectone.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Projectone.view.querybuildernewmodel.querycondition.QuerySelectController',
