Ext.define('Projectone.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Projectone.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
