Ext.define('Projectone.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Projectone.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Projectone.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Projectone.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Projectone.view.querybuildernewmodel.querydetail.QueryDetail');
