Ext.define('Projectone.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Projectone.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Projectone.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Projectone.view.querybuildernewmodel.floatingentity.EntitySprite',
