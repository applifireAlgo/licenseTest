 ...
 * 
 */
Ext.define('Projectone.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Projectone.view.securityconfig.SecurityConfigController',
			'Projectone.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
