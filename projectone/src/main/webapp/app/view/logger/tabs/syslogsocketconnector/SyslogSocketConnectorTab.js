 ...
 * 
 */
Ext.define('Projectone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Projectone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
