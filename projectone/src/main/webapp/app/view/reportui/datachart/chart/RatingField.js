...
Ext.define('Projectone.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Projectone.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Projectone.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
