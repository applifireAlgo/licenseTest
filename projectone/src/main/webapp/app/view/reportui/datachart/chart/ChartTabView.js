Ext.define('Projectone.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Projectone.view.reportui.datachart.chart.RatingField','Projectone.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
