Ext.define('Projectone.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Projectone.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Projectone.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Projectone.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Projectone.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
