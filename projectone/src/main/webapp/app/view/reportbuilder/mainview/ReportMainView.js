Ext.define('Projectone.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Projectone.view.reportbuilder.reportlist.ReportListPanelView',
             'Projectone.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Projectone.view.reportbuilder.mainview.ReportMainController'
             ],
