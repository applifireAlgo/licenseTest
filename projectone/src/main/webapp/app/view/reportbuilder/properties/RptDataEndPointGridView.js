Ext.define('Projectone.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Projectone.view.reportbuilder.properties.RptDataEndPointGridController'],
