Ext.define('Projectone.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Projectone.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Projectone.view.reportbuilder.gridconfig.GridConfigView',
	           'Projectone.view.reportbuilder.properties.PropertiesPanelView',
	           'Projectone.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
