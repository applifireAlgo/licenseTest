Ext.define('Projectone.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Projectone.view.resource.ResourcePanel',
			'Projectone.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Projectone.view.resource.DockedResourcePanel','Projectone.view.fw.mainViewPanel.MainPanelController' ],
