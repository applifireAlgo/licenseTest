 ...
 * 
 */
Ext.define("Projectone.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Projectone.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
