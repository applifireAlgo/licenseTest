package projectone.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* projectone.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* projectone.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* projectone.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* projectone.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* projectone.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* projectone.app.server.repository..*(..))")
