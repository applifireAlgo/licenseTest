package projectone.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* projectone.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* projectone.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* projectone.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* projectone.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* projectone.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* projectone.app.server.service..get*(..))")
