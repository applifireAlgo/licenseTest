package projectone.app.shared.customers;
...
public class AppCustomerCategory implements Serializable, CommonEntityInterface, Comparator<AppCustomerCategory> {
    ...
    public boolean equals(Object obj) {
        try {
            projectone.app.shared.customers.AppCustomerCategory other = (projectone.app.shared.customers.AppCustomerCategory) obj;
            if (appcustCategoryId == null) {
                return false;
